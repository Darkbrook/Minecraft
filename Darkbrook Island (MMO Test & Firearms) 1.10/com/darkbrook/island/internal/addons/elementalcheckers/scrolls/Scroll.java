...
public abstract class Scroll {
	...
	public void unlock(Player player) {
		References.playerdata.set(player.getUniqueId() + ".scrolls." + name.replace(" ", "").toLowerCase(), true);
	}
	...
	public static boolean hasScroll(Player player, String name) {
		return References.playerdata.contains(player.getUniqueId() + ".scrolls." + name);
	}
	...
	public void use(ElementalCheckersPlayer player) {
		...
		player.setGameItem(Gui.getSlot(1, 3), getCooldown(cooldown));
